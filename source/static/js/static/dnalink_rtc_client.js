...
const RTCCLIENT_CONFIG_TNS_SERVER_URL = 'https://groupbuying.opencom.cn:441'//'http://127.0.0.1:3000'// 'http://127.0.0.1:3000'//
...
class RTCClient
{
    constructor(roomid,tns_server_url,options)
    {
        ...
        this.tns_server_url = tns_server_url?tns_server_url:RTCCLIENT_CONFIG_TNS_SERVER_URL
