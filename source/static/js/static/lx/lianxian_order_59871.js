/**
 * Created by container:192.168.1.159:62000 on 2021-02-27 11:19
 */
// const str_filter = require('./libs/str_filter');
// const HOST_SPACE = str_filter.getIPAdress();
const LORDER_TOKEN_NAMESPACE_PRE_FIX="chat02G32Zmqgh8P_"
const LORDER_TOKEN_NAMESPACE='order'
window.lorder_config={}
window.lorder_config.fsm_config = {
...
window.lorder_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:LORDER_TOKEN_NAMESPACE+'_0000000000000000',
        /**
     ...
     * token的主要数值类型NUM
     */
    TOKEN_VAL_TYPE:'CLT', //这里一旦初始化不能修改（否则会导致状态机出问题）
    ///**
     ...
     */
    TOKEN_NAME:LORDER_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:LORDER_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:LORDER_TOKEN_NAMESPACE_PRE_FIX,
    /**
     ...
     */
    TOKEN_GROUP:'poplang.dtns',

    appids:[10001],
    secret_keys:["000000000000000000"],
}
