...
const LGSB_TOKEN_NAMESPACE_PRE_FIX="chat02G32Zmqgh8P_"
const LGSB_TOKEN_NAMESPACE='gsb'
window.lgsb_config= {}
window.lgsb_config.fsm_config = {
...
window.lgsb_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:LGSB_TOKEN_NAMESPACE+'_0000000000000000',
        /**
     ...
     */
    TOKEN_NAME:LGSB_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:LGSB_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:LGSB_TOKEN_NAMESPACE_PRE_FIX,
    /**
