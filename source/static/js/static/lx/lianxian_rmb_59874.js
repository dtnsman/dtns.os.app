/**
 * Created by container:192.168.1.159:62000 on 2021-02-27 11:17
 */
// const str_filter = require('./libs/str_filter');
// const HOST_SPACE = str_filter.getIPAdress();

const LRMB_TOKEN_NAMESPACE_PRE_FIX="chat02G32Zmqgh8P_"
const LRMB_TOKEN_NAMESPACE='rmb'
window.lrmb_config = {}
window.lrmb_config.fsm_config = {
...
window.lrmb_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:LRMB_TOKEN_NAMESPACE+'_0000000000000000',
        /**
     ...
     */
    TOKEN_NAME:LRMB_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:LRMB_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:LRMB_TOKEN_NAMESPACE_PRE_FIX,
    /**
