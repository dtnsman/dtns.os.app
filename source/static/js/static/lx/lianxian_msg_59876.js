...
const LMSB_TOKEN_NAMESPACE_PRE_FIX="chat02G32Zmqgh8P_"
const LMSG_TOKEN_NAMESPACE='msg'
window.lmsg_config = {}
window.lmsg_config.fsm_config = {
...
window.lmsg_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:LMSG_TOKEN_NAMESPACE+'_0000000000000000',
        /**
     ...
     * token的主要数值类型NUM
     */
    TOKEN_VAL_TYPE:'MSG', //这里一旦初始化不能修改（否则会导致状态机出问题）
    ///**
     ...
     */
    TOKEN_NAME:LMSG_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:LMSB_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:LMSB_TOKEN_NAMESPACE_PRE_FIX,
    /**
