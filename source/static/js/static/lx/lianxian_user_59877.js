/**
 * Created by container:192.168.1.159:62000 on 2021-02-27 10:10
 */
// const str_filter = require('./libs/str_filter');
// const HOST_SPACE = str_filter.getIPAdress();
const LUSER_TOKEN_NAMESPACE_PRE_FIX="chat02G32Zmqgh8P_"
const LUSER_TOKEN_NAMESPACE='user'
window.luser_config= {}
window.luser_config.fsm_config = {
...
window.luser_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:LUSER_TOKEN_NAMESPACE+'_0000000000000000',
        /**
     ...
     */
    TOKEN_NAME:LUSER_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:LUSER_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:LUSER_TOKEN_NAMESPACE_PRE_FIX,
    /**
