...
const DTNS_TOKEN_NAMESPACE_PRE_FIX="dtnsnetwork_"
const DTNS_TOKEN_NAMESPACE='dtns'

window.dtns_config= {}
window.dtns_config.fsm_config = {
...
window.dtns_config.root_config={
    route_module_path:'',
    //需要TOKEN_ID_LENGTH的长度（指是的token_id的id长度）
    TOKEN_ROOT:DTNS_TOKEN_NAMESPACE+'_00000000000000000000000000000000',
        /**
     ...
     * token的状态机
     */
    TOKEN_FSM:'pop.fsm',//（使用TOKEN_VAL_TYPE进行真正的fms-state计算）
     ...
     */
    TOKEN_NAME:DTNS_TOKEN_NAMESPACE,
    TOKEN_NAME_PREFIX:DTNS_TOKEN_NAMESPACE_PRE_FIX,
    TNS_NAMESPACE:DTNS_TOKEN_NAMESPACE_PRE_FIX,
    /**
     * token_ID的长度（一般16位左右就足够了）
     */
    TOKEN_ID_LENGTH:32,
    // TOKEN_CLT_TIPS:'DXX|RMB',//以|作为分隔符号
    TOKEN_CLT_TIPS_STR:'000',//默认为此(用于截断token_id)
    /**
