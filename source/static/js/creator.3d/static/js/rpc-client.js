...
class RTCClient{
    ...
    async init()
    {
        ...
        let web3appInfo = await g_dtnsManager.nslookup('dtns://web3:'+g_dtnsManager.getOriginRoomID(this.roomid.startsWith('devtools')?'dtns':this.roomid))
    ...
    async join() {
        ...
        console.log('rpc_client:this.options:',this.options)
