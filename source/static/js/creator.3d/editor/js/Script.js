...
function Script( editor ) {
	...
	codemirror.on( 'change', function () {
		...
		delay = setTimeout( function () {
			...
			let vflag = validate( value )
			console.log('codemirror-validate-vflag:',vflag,typeof ( currentScript ) === 'object')
	...
	const validate = function ( string ) {
		...
		let valid;
		let errors = [];
		console.log('validate-currentMode:',currentMode)

		//hack the code 2023-10-26  对poplang代码不进行错误提示和处理
		return currentMode == 'javascript' || codemirror.operation( function () {
