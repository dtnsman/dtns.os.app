<template>
  <div>
    <div  @click="download(fileInfo)" style="display: inline-block;">
      ...
      <svg v-else-if="!fileInfo.filename || fileInfo.filename.indexOf('.')<0" t="1587622837875" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2050" :width="w" :height="h"><path d="M510.462462 0H119.927928v1024h777.993994V372.084084" fill="#66A924" p-id="2051"></path><path d="M513.537538 0l3.075075 372.084084h387.459459L513.537538 0z" fill="#54831C" p-id="2052"></path></svg>
      <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'a'" t="1587622940022" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2312" :width="w" :height="h"><path d="M513.537538 0H123.003003v1024h777.993994V372.084084" fill="#F3C346" p-id="2313"></path><path d="M513.537538 0l3.075075 372.084084h384.384384L513.537538 0z" fill="#C1932B" p-id="2314"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'b'" t="1587623071394" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2444" :width="w" :height="h"><path d="M510.462462 0H119.927928v1024h777.993994V372.084084" fill="#F446A4" p-id="2445"></path><path d="M513.537538 0l3.075075 372.084084h387.459459L513.537538 0z" fill="#BC2A85" p-id="2446"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'c'" t="1587623134223" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2840" :width="w" :height="h"><path d="M510.462462 0H119.927928v1024h777.993994V372.084084" fill="#FF7D02" p-id="2841"></path><path d="M513.537538 0l3.075075 372.084084h387.459459L513.537538 0z" fill="#D55D03" p-id="2842"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'd'" t="1587622890499" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2182" :width="w" :height="h"><path d="M513.537538 0H123.003003v1024h777.993994V372.084084" fill="#2599F7" p-id="2183"></path><path d="M513.537538 0l3.075075 372.084084h384.384384L513.537538 0z" fill="#2A73DD" p-id="2184"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'e'" t="1587622837875" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2050" :width="w" :height="h"><path d="M510.462462 0H119.927928v1024h777.993994V372.084084" fill="#66A924" p-id="2051"></path><path d="M513.537538 0l3.075075 372.084084h387.459459L513.537538 0z" fill="#54831C" p-id="2052"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'h'" t="1587623334311" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3368" :width="w" :height="h"><path d="M513.537538 0H123.003003v1024h777.993994V372.084084" fill="#F37746" p-id="3369"></path><path d="M513.537538 0l3.075075 372.084084h384.384384L513.537538 0z" fill="#D05C3D" p-id="3370"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'i'" t="1587623447702" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3632" :width="w" :height="h"><path d="M513.537538 0H123.003003v1024h777.993994V372.084084" fill="#F3C346" p-id="3633"></path><path d="M513.537538 0l3.075075 372.084084h384.384384L513.537538 0z" fill="#C1932B" p-id="3634"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'j'" t="1587623178388" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2972" :width="w" :height="h"><path d="M513.537538 0H123.003003v1024h777.993994V372.084084" fill="#E52940" p-id="2973"></path><path d="M513.537538 0l3.075075 372.084084h384.384384L513.537538 0z" fill="#B52533" p-id="2974"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'm'" t="1587623490323" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3764" :width="w" :height="h"><path d="M510.462462 0H119.927928v1024h777.993994V372.084084" fill="#D146F4" p-id="3765"></path><path d="M513.537538 0l3.075075 372.084084h387.459459L513.537538 0z" fill="#9C31C4" p-id="3766"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'p'" t="1587623230401" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3104" :width="w" :height="h"><path d="M513.537538 0H123.003003v1024h777.993994V372.084084" fill="#EE4B4B" p-id="3105"></path><path d="M513.537538 0l3.075075 372.084084h384.384384L513.537538 0z" fill="#C84343" p-id="3106"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'r'" t="1587623609597" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4024" :width="w" :height="h"><path d="M510.462462 0H119.927928v1024h777.993994V372.084084" fill="#3D42FF" p-id="4025"></path><path d="M513.537538 0l3.075075 372.084084h387.459459L513.537538 0z" fill="#2A36D1" p-id="4026"></path></svg>
            <svg v-else-if="fileInfo.filename.split('.')[1][0] === 'z'" t="1587622940022" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2312" :width="w" :height="h"><path d="M513.537538 0H123.003003v1024h777.993994V372.084084" fill="#F3C346" p-id="2313"></path><path d="M513.537538 0l3.075075 372.084084h384.384384L513.537538 0z" fill="#C1932B" p-id="2314"></path></svg>
    ...
    <div v-if="op_edit && fileInfo.name!='..'"  style="display: inline-block;">
      ...
      <span @click="copyOP">复制</span>&nbsp; 
      <span @click="topOP">置顶</span> &nbsp; 
...
export default {
    ...
    methods:{
        aiDocs()
        {
          localStorage.setItem('ibchat-session-file-id',this.fileInfo.type == 'folder' ? this.folder_id: 'folder:'+ this.fileInfo.url)
