/**
 * create by lauo ,2022/9/22
 */
//  global.TOKEN_NAMESPACE_PRE_FIX="lauo_"
//  global.TOKEN_NAMESPACE='valuetest'
...
const TOKEN_NAMESPACE_PRE_FIX="lauo_"
const TOKEN_NAMESPACE='valuetest'
...
const root_config={
     ...
     * token的状态机
     */
    TOKEN_FSM:'dnalink.fsm',//（使用TOKEN_VAL_TYPE进行真正的fms-state计算）
    // TOKEN_OPLIST:JSON.stringify(oplist),
    /**
     * token的主要数值类型NUM
     */
    TOKEN_VAL_TYPE:'TEXT', //这里一旦初始化不能修改（否则会导致状态机出问题）
    ///**
    ...
    appids:[10001],
    secret_keys:['39f01b58558ba38d831744a0d353d7a3']//["bbdbffb24df77be206c820bbe06ae02c"],
}
const protocol =  {fsm_config,root_config}
